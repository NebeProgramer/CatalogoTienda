...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function perfiles() {
        ...
        if (usuarioSesion && usuarioSesion.nombre) {
            ...
            if (bienvenida) {
                bienvenida.textContent = usuarioSesion.nombre ? `¡Bienvenido ${usuarioSesion.nombre} a PawMarket!` : `¡Bienvenido Invitado a PawMarket!`;
            } else {
    ...
    async function verificarUsuarioGoogle() {
    try {
        ...
        if (respuesta.ok) {
            ...
            if (usuario) {
                ...
                const bienvenida = document.querySelector('.bienvenida');
                if (bienvenida) {
                    bienvenida.textContent = usuario.nombre
                        ? `Bienvenido ${usuario.nombre} a nuestra tienda!`
